...
document.getElementById('caption BR').innerHTML='<a href=#>[Registrations of '+ res[0].results[0].mh +' '+res[0].results[0].Cn_short+' by year]</A></P></div>';
document.getElementById('caption BR1').innerHTML='<a href=#>[Registrations of '+ res[0].results[0].mh +' '+res[0].results[0].Cn_short+' by country in 2020]</A></P></div>';
document.getElementById('caption BR2').innerHTML='<a href=#>[Avg Ewltp for '+res[0].results[0].mh+' by year]</A></P></div>';
