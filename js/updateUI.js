function showData() {
	//update the text
	//build the string
	txt = 'We detected a <B>' + obj[0].Mh + ' </B> <B>'+obj[0].Cn_short+'</B> with <B>99%</B> confidence.<P><B>Registrations in Europe ('+obj[0].year+'):</B> '+obj[0].countVIN+' vehicles<P><B>Average specific CO<sub>2</sub> Emissions</B>: '+obj[0].avgEWLTP+' g/km<P><B>Average engine capacity:</B> '+obj[0].avgEc+'cm<sup>3</sup><P><B>Average engine power:</B> '+obj[0].avgEp+'kwh<P><B>Average mass in running order:</B> '+obj[0].avgM+'kg';
